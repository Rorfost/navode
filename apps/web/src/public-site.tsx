...
function PrivacyPage() {
  return (
    <article className="public-prose" aria-labelledby="privacy-title">
      <p className="eyebrow">PRIVACY POLICY · V2.4</p>
      ...
      <p>
        ...
        configured GitHub repository reference, short-lived Google Calendar daily context, and an
        optional public Codeforces handle with short-lived public contest and profile context.
      ...
      <p>
        ...
        stores it in that browser’s local storage. V2.4 does not provide cloud sync, accounts, or a
      ...
      <p>
        ...
        GitHub, Google Calendar, and Codeforces are contacted only after you explicitly connect them.
        Calendar requests are read-only; Codeforces uses only public documented API endpoints and
        never asks for an API key. Neither reaches Navode infrastructure. When you intentionally run a
      ...
      <p>
        V2.4 has no analytics, telemetry, advertising identifiers, user accounts, or Navode authentication.
      </p>
